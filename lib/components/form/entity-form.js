...
export var EntityForm = function (props) {
    var _a;
    var formRef = props.formRef, onSave = props.onSave, onValuesChanged = props.onValuesChanged, showButtons = props.showButtons;
    ...
    return (React.createElement(Form, __assign({ key: JSON.stringify(resource.data), form: form, onFinish: function (values) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    setSaving(true);
