...
export var EntityForm = function (props) {
    ...
    var content = entity.getCardLayout("edit", {
        entity: entity,
        resource: resource,
        formInstance: ((_a = formRef) === null || _a === void 0 ? void 0 : _a.current) || undefined,
        id: resourceID,
        data: resource.data || {},
        fields: fields,
    });
    return (React.createElement(ResourceForm, __assign({ formResource: resource, onSuccess: function () { return handleFormSuccess(resource); }, formRef: formRef, onValuesChange: onValuesChanged, layout: "vertical" }, form),
