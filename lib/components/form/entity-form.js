...
export var EntityForm = function (props) {
    ...
    return (React.createElement(Form, __assign({ form: form, onFinish: function (values) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    setSaving(true);
        ...
        }); }, onValuesChange: onValuesChanged, layout: "vertical" }, form),
        React.createElement(Spin, { spinning: (resource.loading && !resource.polling) || saving }, content)));
};
