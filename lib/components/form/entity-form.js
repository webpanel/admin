...
var isEditProps = function (props) {
    return typeof props.resourceID !== "undefined";
};
export var EntityForm = function (props) {
    var formRef = props.formRef, onSave = props.onSave, onValuesChanged = props.onValuesChanged;
    ...
    var entity = props.entity, form = props.form, initialValues = props.initialValues, fields = props.fields;
    ...
    return (React.createElement(ResourceForm, __assign({ formResource: resource, onSuccess: function () { return handleFormSuccess(resource); }, formRef: function (form) { return setFormInstance(form); }, onValuesChange: onValuesChanged, layout: "vertical" }, form),
