...
export var EntityForm = function (props) {
    ...
    return (React.createElement(ResourceForm, __assign({ formResource: resource, onSuccess: function (context) { return handleFormSuccess(resource); } }, form, { render: function (formContext) {
