...
var FileInput = /** @class */ (function (_super) {
    ...
    FileInput.prototype.renderFile = function () {
        ...
        var _a = this.props, entity = _a.entity, accessToken = _a.accessToken;
        ...
        return (React.createElement(ResourceLayer, { name: "File", id: value, dataSource: entity.dataSource, fields: ["url", "name", "size"], render: function (_a) {
                var data = _a.data;
                return (data && (React.createElement("a", { target: "_blank", href: data.url + "?access_token=" + token },
                    data.name,
                    " (",
    ...
    FileInput.prototype.render = function () {
        var _this = this;
        var value = this.state.value;
        var _a = this.props, fileUploadURL = _a.uploadURL, accessToken = _a.accessToken;
        var token = resolveOptionalThunk(accessToken);
        var headers = {};
        if (token) {
