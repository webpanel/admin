...
import { CreateEntityModal } from "./EntityAddModal";
...
export var CreateEntityButton = function (props) {
    ...
    if (_flow.type === "modal") {
        return (React.createElement(React.Fragment, null,
            React.createElement(CreateEntityModal, __assign({ entity: entity, modal: __assign({ visible: modalVisible, onCancel: function () { return hideModal(); } }, _flow.modal) }, rest)),
...
//# sourceMappingURL=CreateEntityAddButton.js.map