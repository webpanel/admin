    ...
    DetailEntityButton.prototype.render = function () {
        ...
        if (_flow.type === "modal") {
            ...
            return (React.createElement(Translation, { key: key }, function (t) { return (React.createElement(React.Fragment, null,
                React.createElement("div", { style: { position: "absolute" } }, entity.getDetailView(entityId, __assign({ wrapperType: "modal", modal: __assign(__assign({ title: t(entity.name + "._title", {
                            defaultValue: "" + entity.title
                        }), onCancel: _this.hideModal, footer: !hideLinkToDetail &&
