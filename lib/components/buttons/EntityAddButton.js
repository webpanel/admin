...
export var CreateEntityButton = function (props) {
    ...
    if (_flow.type === "modal") {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(Modal, { visible: modalVisible, onOk: function () { var _a, _b; return (_b = (_a = formRef) === null || _a === void 0 ? void 0 : _a.current) === null || _b === void 0 ? void 0 : _b.submit(); }, onCancel: function () { return setModalVisible(false); }, title: getTitle(), destroyOnClose: true }, entity.getCreateView({
