...
export var CreateEntityButton = function (props) {
    var entity = props.entity, flow = props.flow, button = props.button, onSave = props.onSave, rest = __rest(props, ["entity", "flow", "button", "onSave"]);
    ...
    if (_flow.type === "modal") {
        return (React.createElement(React.Fragment, null,
            React.createElement(CreateEntityModal, __assign({ entity: entity, modal: __assign(__assign({}, _flow.modal), { onCancel: function () { return hideModal(); }, visible: modalVisible }) }, rest, { onSave: function (resourceId) { return __awaiter(void 0, void 0, void 0, function () {
