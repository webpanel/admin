...
export type EntitylistActionButton<T extends EntityDataType = any> = "detail" | "edit" | "delete" | React.ReactNode | ((props: EntityListActionButtonProps<T>) => React.ReactNode);
