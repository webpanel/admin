...
var EntityDetail = /** @class */ (function (_super) {
    ...
    EntityDetail.prototype.render = function () {
        ...
        return (React.createElement(Translation, null, function (t) { return (React.createElement(ResourceLayer, { name: entity.name, id: resourceID, dataSource: entity.dataSource, fields: [
                ...
                if (layout)
                    return layout;
                return (React.createElement(Card, { title: t(entity.name + ".title", { default: entity.title }), loading: resource.loading && !resource.polling, extra: React.createElement(Link, { to: resourceID + "/edit" },
                        React.createElement(Button, { size: "small", htmlType: "button", icon: "edit" })) },
                    React.createElement(Form, null, entity.detailFields.map(function (field, i) { return (React.createElement(Form.Item, __assign({ key: field.name + "_" + i, label: t(entity.name + "." + field.name, {
                            default: field.title
