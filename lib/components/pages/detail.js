...
var EntityDetail = /** @class */ (function (_super) {
    ...
    EntityDetail.prototype.render = function () {
        var _a = this.props, entity = _a.entity, resourceID = _a.resourceID;
        var formItemLayout = {
            labelCol: {
                xs: { span: 24 },
                sm: { span: 8 }
        ...
        return (React.createElement(ResourceLayer, { name: entity.name, id: resourceID, dataSource: entity.dataSource, fields: [
                "id"
                ...
                if (layout)
                    return layout;
                return (React.createElement(Card, { title: entity.title, extra: React.createElement(Link, { to: resourceID + "/edit" },
