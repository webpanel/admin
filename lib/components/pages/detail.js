...
var EntityDetail = /** @class */ (function (_super) {
    ...
    EntityDetail.prototype.render = function () {
        ...
        return (React.createElement(ResourceLayer, { name: entity.name, id: id, dataSource: this.props.dataSource, fields: ['id'].concat(entity.listFields.map(function (x) { return x.fetchField; })), render: function (resource) { return (React.createElement(Card, { title: entity.title, extra: React.createElement(Link, { to: id + "/edit" },
                ...
                React.createElement(Col, { span: 12 }, resource.data && resource.data[field.name]))); }))); } }));
    };
    return EntityDetail;
}(React.Component));
export { EntityDetail };
