...
var EntityDetail = /** @class */ (function (_super) {
    ...
    EntityDetail.prototype.render = function () {
        var _a = this.props, entity = _a.entity, resourceID = _a.resourceID, pollInterval = _a.pollInterval, wrapperType = _a.wrapperType, modal = _a.modal, card = _a.card;
        ...
        return (React.createElement(Translation, null, function (t) { return (React.createElement(ResourceLayer, { name: entity.name, id: resourceID, dataSource: entity.dataSource, fields: __spreadArrays([
                ...
                switch (wrapperType) {
                    ...
                    default:
                        return (React.createElement(Card, __assign({ title: t(entity.name + "._title", {
                                defaultValue: entity.title
                            }) +
                                " " +
                                (resource.data && entity.render(resource.data)), loading: resource.loading && !resource.polling, extra: entity.updateable && entity.getEditButton(resourceID) }, card), content));
                }
            } })); }));
    };
    return EntityDetail;
