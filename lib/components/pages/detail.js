...
var EntityDetail = /** @class */ (function (_super) {
    ...
    EntityDetail.prototype.render = function () {
        ...
        var contentFn = function (resource, t) { return (React.createElement(Descriptions, { bordered: false, size: "small", column: { md: 2, xs: 1 } }, entityFields.map(function (field, i) { return (React.createElement(Descriptions.Item, { key: field.name + "_" + i, label: t(entity.name + "." + field.name, {
