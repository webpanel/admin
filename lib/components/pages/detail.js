...
var EntityDetail = /** @class */ (function (_super) {
    ...
    EntityDetail.prototype.render = function () {
        ...
        return (React.createElement(ResourceLayer, { name: entity.name, id: id, dataSource: entity.dataSource, fields: ['id'].concat(entity.detailFields.map(function (x) { return x.fetchField; })), render: function (resource) { return (React.createElement(Card
            // title={entity.title}
            // extra={
            //   <Link to={`${id}/edit`}>
