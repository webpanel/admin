...
var EntityList = /** @class */ (function (_super) {
    ...
    EntityList.prototype.render = function () {
        var _this = this;
        var _a = this.props, entity = _a.entity, table = _a.table, card = _a.card, searchable = _a.searchable, showAddButton = _a.showAddButton, fields = _a.fields, initialFilters = _a.initialFilters, initialSorting = _a.initialSorting, title = _a.title, autopersistConfigKey = _a.autopersistConfigKey;
