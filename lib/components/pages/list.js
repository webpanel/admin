...
var EntityList = /** @class */ (function (_super) {
    ...
    EntityList.prototype.getColumns = function (listFields, resource, t) {
        ...
        return listFields.map(function (column) {
            var field = column.field, render = column.render, align = column.align;
            ...
            return {
                ...
                render: function (value, record, index) {
                    ...
                    return (React.createElement(ListCell, { collection: resource, values: values, field: field, editable: _editableFields.indexOf(field.name) > -1 && field.writeable, fields: entityListFields }));
                }
            };
        });
    };
    EntityList.prototype.getListFields = function () {
        ...
        if (_fields) {
            for (var _i = 0, _fields_1 = _fields; _i < _fields_1.length; _i++) {
                ...
                listFields.push({ field: field, hidden: hidden, render: render, align: align });
            }
        }
        else {
