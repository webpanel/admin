...
var EntityList = /** @class */ (function (_super) {
    ...
    EntityList.prototype.render = function () {
        var _this = this;
        var _a = this.props, entity = _a.entity, table = _a.table, card = _a.card, searchable = _a.searchable, showAddButton = _a.showAddButton, fields = _a.fields, initialFilters = _a.initialFilters, initialSorting = _a.initialSorting, title = _a.title, autopersistConfigKey = _a.autopersistConfigKey, pollInterval = _a.pollInterval;
        ...
        return (React.createElement(ResourceCollectionLayer, { name: entity.name, dataSource: this.props.dataSource, autopersistConfigKey: autopersistConfigKey, fields: [
                ...
                .filter(function (x) { return x; })), initialSorting: initialSorting || entity.initialSorting, initialFilters: initialFilters || entity.initialFilters, pollInterval: pollInterval, initialLimit: (table && table.pagination && table.pagination.defaultPageSize) ||
                undefined, render: function (resource) { return (React.createElement(Card, { bodyStyle: { padding: '0' }, title: title || entity.title, extra: [
                ...
                React.createElement(ResourceTable, __assign({ className: "entitytable", scroll: { x: true }, resourceCollection: resource, pagination: (table && table.pagination) || {
                        defaultPageSize: 30,
