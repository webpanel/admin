...
var EntityList = /** @class */ (function (_super) {
    ...
    EntityList.prototype.render = function () {
        var _this = this;
        var _a = this.props, entity = _a.entity, table = _a.table, fields = _a.fields, initialFilters = _a.initialFilters, initialSorting = _a.initialSorting;
        ...
        return (React.createElement(ResourceCollectionLayer, { name: entity.name, dataSource: this.props.dataSource, fields: [
                'id'
            ].concat(listFields.map(function (x) { return x.fetchField(); }).filter(function (x) { return x; })), initialSorting: initialSorting || entity.initialSorting, initialFilters: initialFilters || entity.initialFilters, render: function (resource) { return (React.createElement(Card, { bodyStyle: { padding: '0' }, title: entity.title, extra: [
