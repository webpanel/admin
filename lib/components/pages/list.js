...
var EntityList = /** @class */ (function (_super) {
    ...
    EntityList.prototype.cardContent = function (resource) {
        ...
        return (React.createElement(Card, { bodyStyle: { padding: '0' }, title: title || entity.title, extra: [
                ...
                _addButton && entityPermission(entity, 'create') && (React.createElement(EntityAddButton, __assign({ entity: entity, onCreate: function () { return resource.reload(); } }, _addButton))),
                card && card.extra
            ].filter(function (x) { return x; }) }, this.tableContent(resource)));
    };
    EntityList.prototype.tableContent = function (resource) {
        ...
        return (React.createElement(ResourceTable, __assign({ className: "entitytable", scroll: { x: true }, resourceCollection: resource, pagination: (table && table.pagination) || {
            ...
            } }, table, { columns: this.getColumns(this.getListFields().filter(function (x) { return !x.hidden; }), resource) })));
    };
    EntityList.prototype.render = function () {
        var _this = this;
        var _a = this.props, entity = _a.entity, initialFilters = _a.initialFilters, initialSorting = _a.initialSorting, initialLimit = _a.initialLimit, autopersistConfigKey = _a.autopersistConfigKey, pollInterval = _a.pollInterval, displayMode = _a.displayMode;
        return (React.createElement(Translation, null, function (t) { return (React.createElement(ResourceCollectionLayer, { name: t(entity.name, { count: 5 }), dataSource: _this.props.dataSource, autopersistConfigKey: autopersistConfigKey, fields: [
                'id'
                ...
                return displayMode && displayMode === 'plain'
                    ? _this.tableContent(resource)
                    : _this.cardContent(resource);
            } })); }));
    };
    return EntityList;
}(React.Component));
