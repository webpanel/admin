    ...
    EntityList.prototype.render = function () {
        ...
        if (_fields) {
            for (var _i = 0, _fields_1 = _fields; _i < _fields_1.length; _i++) {
                ...
                listFields.push({ field: field, render: render });
            }
        }
        else {
        ...
        var searchable = table && typeof table.searchable !== "undefined"
            ? table.searchable
            : entity.searchable;
        return (React.createElement(ResourceCollectionLayer, { name: entity.name, dataSource: this.props.dataSource, fields: [
                ...
                .filter(function (x) { return x; })), initialSorting: initialSorting || entity.initialSorting, initialFilters: initialFilters || entity.initialFilters, render: function (resource) { return (React.createElement(Card, { bodyStyle: { padding: "0" }, title: title || entity.title, extra: [
                    searchable && (React.createElement(ResourceSearchInput, { key: "searchInput", resourceCollection: resource, size: "small", style: { width: 300, marginRight: 8 } })),
                    entityPermission(entity, "create") && (React.createElement(Link, { to: entity.getCreateLink(), key: "newButton" },
                ...
                React.createElement(ResourceTable, __assign({ className: "entitytable", scroll: { x: true }, resourceCollection: resource, pagination: {
                    ...
                    ].filter(function (x) { return x; }) }, table, { columns: _this.getColumns(listFields, resource) })))); } }));
    };
    return EntityList;
}(React.Component));
export { EntityList };
