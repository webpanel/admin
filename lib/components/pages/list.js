...
var EntityList = /** @class */ (function (_super) {
    ...
    EntityList.prototype.render = function () {
        var _a = this.props, entity = _a.entity, table = _a.table, editableFields = _a.editableFields, fields = _a.fields;
        var rowValues = {};
        var _editableFields = editableFields || [];
        var listFields = (fields &&
            fields
                .map(function (f) { return entity.getField(f); })
                .filter(function (x) { return x && x.visible('list'); })) ||
            entity.listFields;
        return (React.createElement(ResourceCollectionLayer, { name: entity.name, dataSource: this.props.dataSource, fields: ['id'].concat(listFields.map(function (x) { return x.fetchField; })), initialSorting: entity.initialSorting, initialFilters: entity.initialFilters, render: function (resource) { return (React.createElement(Card, { bodyStyle: { padding: '0' }, title: entity.title, extra: [
                    ...
                    entityPermission(entity, 'create') && (React.createElement(Link, { to: "new", key: "newButton" },
                ...
                React.createElement(ResourceTable, __assign({ className: "entitytable", scroll: { x: true }, resourceCollection: resource, pagination: {
                    ...
                    } }, table, { columns: listFields.map(function (field) {
