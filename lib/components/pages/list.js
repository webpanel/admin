...
var EntityList = /** @class */ (function (_super) {
    ...
    EntityList.prototype.render = function () {
        ...
        return (React.createElement(ResourceCollectionLayer, { name: entity.name, dataSource: this.props.dataSource, fields: ['id'].concat(entity.listFields.map(function (x) { return x.fetchField; })), initialSorting: entity.initialSorting, initialFilters: entity.initialFilters, render: function (resource) { return (React.createElement(Card, { bodyStyle: { padding: '0' }, title: React.createElement("div", null,
                ...
                React.createElement(ResourceTable, __assign({ className: "entitytable", scroll: { x: true }, resourceCollection: resource, pagination: { pageSize: 30, showSizeChanger: true } }, table, { columns: entity.listFields.map(function (field) {
