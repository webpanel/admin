...
var EntityList = /** @class */ (function (_super) {
    ...
    EntityList.prototype.render = function () {
        ...
        return (React.createElement(ResourceCollectionLayer, { name: entity.name, dataSource: this.props.dataSource, autopersistConfigKey: entity.name + "_list_" + this.props.key, fields: [
                'id'
            ].concat(listFields
