...
export var EntityList = function (props) {
    var getColumns = function (listFields, resource, t) {
        ...
        return listFields.map(function (column) {
            ...
            var col = {
                ...
                align: _align,
                shouldCellUpdate: function () { return false; },
            ...
            if (hasAggregations) {
                col.children = [
                    __assign(__assign({}, col), { title: function () {
                            if (!aggregation) {
                                return;
                            }
    ...
    var entity = props.entity, initialFilters = props.initialFilters, initialSorting = props.initialSorting, wrapperType = props.wrapperType, aggregations = props.aggregations, restProps = __rest(props, ["entity", "initialFilters", "initialSorting", "wrapperType", "aggregations"]);
