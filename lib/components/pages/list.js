...
var EntityList = /** @class */ (function (_super) {
        ...
        return buttons.map(function (item) {
            if (typeof item === 'function') {
                return function (props) {
                    return item(__assign({}, props, { entity: entity }));
                };
            }
            switch (item) {
                case 'edit':
                    return function (props) {
                        return editListButton(__assign({}, props, { entity: entity }), size);
                    };
                case 'detail':
                    return function (props) {
                        return detailListButton(__assign({}, props, { entity: entity }), size);
                    };
                default:
                    return item;
            }
    ...
    EntityList.prototype.tableContent = function (resource, t) {
        ...
        return (React.createElement(ResourceTable, __assign({ className: "entitytable", scroll: { x: true }, resourceCollection: resource, pagination: __assign({}, defaultPagination, (table && table.pagination)), customDetailURL: function (resourceID) {
    ...
    EntityList.prototype.render = function () {
        var _this = this;
        var _a = this.props, entity = _a.entity, initialFilters = _a.initialFilters, initialSorting = _a.initialSorting, initialLimit = _a.initialLimit, initialOffset = _a.initialOffset, autopersistConfigKey = _a.autopersistConfigKey, pollInterval = _a.pollInterval, wrapperType = _a.wrapperType;
        return (React.createElement(Translation, null, function (t) { return (React.createElement(ResourceCollectionLayer, { name: entity.name, dataSource: _this.props.dataSource, autopersistConfigKey: autopersistConfigKey, fields: [
                ...
                .filter(function (x) { return x; })), initialSorting: initialSorting || entity.initialSorting, initialFilters: initialFilters || entity.initialFilters, initialLimit: initialLimit, initialOffset: initialOffset, pollInterval: pollInterval, render: function (resource) {
