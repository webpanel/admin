...
var EntityList = /** @class */ (function(_super) {
  ...
  EntityList.prototype.getColumns = function(listFields, resource, t) {
    var _a = this.props,
      entity = _a.entity,
      editableFields = _a.editableFields;
    var _editableFields =
    ...
    return listFields.map(function(column) {
      ...
      return {
        ...
        render: function(value, record, index) {
          ...
          return React.createElement(ListCell, {
            collection: resource,
            values: values,
            field: field,
            editable:
  ...
  EntityList.prototype.cardContent = function(resource, t) {
    ...
    return React.createElement(
      Card,
      {
        ...
        extra: [
          _searchable &&
            React.createElement(ResourceSearchInput, {
              key: 'searchInput',
      ...
      __assign(
        {
          ...
          customDetailURL: function(resourceID) {
        ...
        table,
        {
          columns: this.getColumns(
            this.getListFields().filter(function(x) {
              return !x.hidden;
            }),
            resource,
            t
  ...
  EntityList.prototype.render = function() {
    ...
    var _a = this.props,
      ...
      initialSorting = _a.initialSorting,
      initialLimit = _a.initialLimit,
      autopersistConfigKey = _a.autopersistConfigKey,
      pollInterval = _a.pollInterval,
      wrapperType = _a.wrapperType;
    return React.createElement(Translation, null, function(t) {
      return React.createElement(ResourceCollectionLayer, {
        name: entity.name,
