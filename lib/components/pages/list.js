...
var EntityList = /** @class */ (function (_super) {
    ...
    EntityList.prototype.getListFields = function () {
        var _a;
        var _b = this.props, entity = _b.entity, fields = _b.fields;
        ...
        if (_fields) {
            ...
            for (var _c = 0, _d = entity.getListFields(); _c < _d.length; _c++) {
                var f = _d[_c];
        ...
        return (React.createElement(Card, __assign({ bodyStyle: { padding: "0" }, title: title ||
                ...
                React.createElement(Space, null,
                    hasTableFilter && (React.createElement(Tooltip, { title: React.createElement(Translation, { ns: "webpanel-admin" }, function (t) { return t("clearFilter"); }) },
                        React.createElement(Button, { icon: React.createElement(FilterOutlined, null), danger: true, size: "small", onClick: function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    EntityList.prototype.render = function () {
        ...
        // });
        return (React.createElement(Translation, null, function (t) { return (React.createElement(ResourceCollectionLayer, __assign({ name: entity.resourceName, dataSource: entity.dataSource }, restProps, { fields: fields, initialSorting: initialSorting || entity.initialSorting, initialFilters: initialFilters || entity.initialFilters, 
