...
export var EntityList = function (props) {
    ...
    var cardContent = function (resource, t) {
        ...
        return (React.createElement(Card, __assign({ bodyStyle: { padding: "0" }, title: title ||
                t("".concat(entity.name, "._title"), { count: 100, defaultValue: entity.title }), key: "".concat(entity.name, ".table-card") }, card, { extra: React.createElement(Space, { key: "default-buttons" },
                card && card.extra,
