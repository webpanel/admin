...
var EntityList = /** @class */ (function (_super) {
    ...
    EntityList.prototype.render = function () {
        ...
        return (React.createElement(ResourceCollectionLayer, { name: entity.name, dataSource: this.props.dataSource, fields: [
                'id'
            ].concat(listFields.map(function (x) { return x.fetchField; }).filter(function (x) { return x; })), initialSorting: entity.initialSorting, initialFilters: entity.initialFilters, render: function (resource) { return (React.createElement(Card, { bodyStyle: { padding: '0' }, title: entity.title, extra: [
