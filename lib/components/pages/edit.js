...
export var EntityEdit = function (props) {
    ...
    var submit = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, ((_b = (_a = formRef) === null || _a === void 0 ? void 0 : _a.current) === null || _b === void 0 ? void 0 : _b.submit())];
                case 1:
                    _c.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    var entityForm = (React.createElement(EntityForm, __assign({ entity: entity }, restProps, { formRef: formRef, onValuesChanged: function (values) { return setFormData(values); } })));
    switch (wrapperType) {
        case "plain":
            return entityForm;
        default:
            return (React.createElement(Card, { title: t(entity.name + "._title", {
                ...
                entityForm,
                React.createElement(ResourceFormPageButtons, { submit: submit, reset: function () { var _a, _b; return (_b = (_a = formRef) === null || _a === void 0 ? void 0 : _a.current) === null || _b === void 0 ? void 0 : _b.resetFields(); } })));
    }
};
