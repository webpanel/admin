...
var EntityEdit = /** @class */ (function (_super) {
    ...
    EntityEdit.prototype.render = function () {
        var _a = this.props, entity = _a.entity, resourceID = _a.resourceID, onCreate = _a.onCreate;
        return (React.createElement(ResourceLayer, { name: entity.name, id: resourceID, fields: entity.editFields.map(function (f) { return f.columnName; }), dataSource: entity.dataSource, onCreate: onCreate, render: function (resource) { return (React.createElement(Card, null,
