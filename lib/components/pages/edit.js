...
var EntityEdit = /** @class */ (function (_super) {
    ...
    EntityEdit.prototype.render = function () {
        var _this = this;
        var _a = this.props, entity = _a.entity, resourceID = _a.resourceID, initialValues = _a.initialValues, onCreate = _a.onCreate, form = _a.form;
        return (React.createElement(ResourceLayer, { key: this.state.version, name: entity.name, id: resourceID, fields: entity.editFieldsWithPermission('read').map(function (f) { return f.columnName; }), dataSource: entity.dataSource, onCreate: onCreate, initialValues: initialValues, render: function (resource) { return (React.createElement(ResourceForm, __assign({ formResource: resource, onSuccess: function (context) {
                    ...
                    return (React.createElement(Card, null,
                        React.createElement(React.Fragment, null,
                            layout ||
                                entity.editFieldsWithPermission('write').map(function (field, i) {
                                    return field.fieldElement(formContext, i, {
                                        formLayout: form && form.layout
                                    });
                                }),
                            React.createElement(ResourceFormPageButtons, { hasChanges: formContext.form.isFieldsTouched(), handleReset: function () {
                                    return formContext.formComponent.resetFields();
