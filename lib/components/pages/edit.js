...
var EntityEdit = /** @class */ (function (_super) {
    ...
    EntityEdit.prototype.render = function () {
        ...
        return (React.createElement(ResourceLayer, { key: this.state.version, name: entity.name, id: resourceID, fields: entity.editFields.map(function (f) { return f.columnName; }), dataSource: entity.dataSource, onCreate: onCreate, initialValues: initialValues, render: function (resource) { return (React.createElement(ResourceForm, __assign({ formResource: resource, onSuccess: function (context) {
