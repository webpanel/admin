...
export var ListCell = function (props) {
    ...
    var onChange = function (value, valueElement) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        editable ? (React.createElement(Popconfirm, { title: field.inputElement({
            ...
            }), onConfirm: function () { return save(); } }, saving ? (React.createElement(LoadingOutlined, null)) : (React.createElement(Button, { shape: "circle", icon: React.createElement(EditOutlined, null), size: "small", className: "no-print", style: { marginLeft: "10px" } })))) : null));
};
