...
var EntityList = /** @class */ (function (_super) {
    ...
    EntityList.prototype.tableContent = function (resource, t) {
        ...
        return (React.createElement(ResourceTable, __assign({ className: "entitytable", scroll: { x: true }, resourceCollection: resource, pagination: __assign({}, defaultPagination, (table && table.pagination)), actionButtons: (table && table.actionButtons) ||
                [
