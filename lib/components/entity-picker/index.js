...
export var EntitySelect = function (props) {
    ...
    return (React.createElement(ResourceSelect, __assign({ resource: __assign(__assign({}, resourceConfig), resource), key: "entity_select_" + entity.name + "_" + key, valueKey: "id", labelKey: function (value) {
