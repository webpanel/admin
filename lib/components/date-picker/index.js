...
var DatePicker = /** @class */ (function (_super) {
    ...
    DatePicker.prototype.render = function () {
        ...
        return (React.createElement(AntdDatePicker, { showTime: true, format: this.getFormat(), defaultPickerValue: moment().minute(0).seconds(0), value: value ? moment(value) : undefined, onChange: function (val) {
                if (onChange) {
