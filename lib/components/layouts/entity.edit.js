...
var EntityEditLayout = /** @class */ (function (_super) {
    ...
    EntityEditLayout.prototype.render = function () {
        var _a = this.props, route = _a.route, form = _a.form;
        return (React.createElement(EntityEdit, { entity: this.props.entity, resourceID: route.match.params.id, route: route, form: form }));
    };
