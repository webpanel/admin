...
var EntityEditLayout = /** @class */ (function (_super) {
    ...
    EntityEditLayout.prototype.render = function () {
        var _a = this.props, route = _a.route, pushDetailOnCreate = _a.pushDetailOnCreate;
        return (React.createElement(EntityEdit, { entity: this.props.entity, resourceID: route.match.params.id, onCreate: function (id) {
