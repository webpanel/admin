...
var EntityEditLayout = /** @class */ (function (_super) {
    ...
    EntityEditLayout.prototype.render = function () {
        var _a = this.props, route = _a.route, form = _a.form, entity = _a.entity, initialValues = _a.initialValues;
        return (React.createElement(EntityEdit, { entity: entity, resourceID: route.match.params.id, route: route, form: form, initialValues: initialValues }));
    };
