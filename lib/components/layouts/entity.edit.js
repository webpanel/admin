...
var EntityEditLayout = /** @class */ (function (_super) {
    ...
    EntityEditLayout.prototype.render = function () {
        var _a = this.props, route = _a.route, onCreate = _a.onCreate;
        return (React.createElement(EntityEdit, { entity: this.props.entity, resourceID: route.match.params.id, onCreate: onCreate }));
    };
