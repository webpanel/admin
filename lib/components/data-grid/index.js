    ...
    DataGrid.prototype.render = function () {
        ...
        return (React.createElement(ResourceCollectionLayer, { dataSource: entity.dataSource, name: entity.name, fields: [
                ...
                return (React.createElement("div", null,
                    ...
                    React.createElement(Modal, { title: "Add new", visible: addingNewEntity, afterClose: function () { return resource.get(); } },
                        React.createElement(EntityEdit, { entity: entity, onCreate: function () { return _this.setState({ addingNewEntity: false }); }, initialValues: newItemInitialValues, wrapperType: "card" })),
