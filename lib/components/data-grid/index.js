...
var DataGrid = /** @class */ (function (_super) {
    ...
    DataGrid.prototype.render = function () {
        var _this = this;
        var _a = this.props, entity = _a.entity, fields = _a.fields, initialFilters = _a.initialFilters;
        ...
        return (React.createElement(ResourceCollectionLayer, { dataSource: entity.dataSource, name: entity.name, fields: ['id'].concat(gridFields.map(function (x) { return x.fetchField; })), initialFilters: initialFilters, render: function (resource) {
                ...
                return (React.createElement("div", null,
                    ...
                    React.createElement(Modal, { align: {}, title: "Add new", visible: addingNewEntity, afterClose: function () { return resource.get(); } },
                        React.createElement(EntityEdit, { entity: entity, onCreate: function () { return _this.setState({ addingNewEntity: false }); } })),
