...
var LayoutBuilder = /** @class */ (function () {
    ...
    LayoutBuilder.prototype.editField = function (props) {
        return (React.createElement(LayoutBuilderEditField, __assign({ key: "LayoutBuilderEditField_" + this.config.entity.name + "_" + props.name }, resolveThunk(props, this.config), { entity: this.config.entity })));
    };
    ...
    LayoutBuilder.prototype.formValue = function (name) {
        var _a;
        return (_a = this.config.formInstance) === null || _a === void 0 ? void 0 : _a.getFieldValue(name);
    };
