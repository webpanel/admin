...
var LayoutBuilderStringField = /** @class */ (function (_super) {
    ...
    LayoutBuilderStringField.prototype.render = function () {
        ...
        return (React.createElement(Translation, null, function (t) { return (React.createElement(Form.Item, __assign({}, props, { 
            //   key={key}
            label: t(field.name, { defaultValue: field.title }), colon: field.title ? true : false }, _this.layouts[layout || 'horizontal']), field.render(data))); }));
    };
