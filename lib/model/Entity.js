...
var Entity = /** @class */ (function () {
    function Entity(config) {
        ...
        this.menuItem = function () {
            return (componentPermission(_this.structureName) && (React.createElement(Layout.MenuItem, { key: _this.structureName, title: React.createElement(Translation, null, function (t) { return t(_this.name, { defaultValue: _this.title }); }), icon: resolveOptionalThunk(_this.config.icon) || 'folder' })));
        };
        this.structureItem = function () {
            return (React.createElement(Layout.StructureItem, { key: _this.getListLink(), name: React.createElement(Translation, null, function (t) { return t(_this.name, { defaultValue: _this.title }); }), header: {
