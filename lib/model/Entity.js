...
var Entity = /** @class */ (function () {
    function Entity(config) {
        ...
        this.handleFormOnSave = function (route) { return function (id, option) {
            switch (option) {
                case 'add':
                    route.history.push('/' + _this.structureName + '/new');
                    break;
                case 'edit':
                    route.history.push('/' + _this.structureName + '/' + id + '/edit');
                    break;
                default:
                    route.history.push('/' + _this.structureName + '/');
                    break;
            }
        }; };
        this.getEditPageLayout = function (route, config) {
            ...
            if (_this.editLayout) {
                return _this.editLayout({ entity: _this, onSave: onSave });
            }
            return (React.createElement(EntityEditLayout, __assign({ entity: _this, onSave: onSave, resourceID: resourceID }, _this.config.edit, config)));
        };
        this.getCreatePageLayout = function (route, config) {
            ...
            return (React.createElement(EntityEditLayout, __assign({ entity: _this, onSave: onSave }, _this.config.edit, config)));
        };
        // views
        this.getListView = function (config) {
            return (React.createElement(EntityList, __assign({ entity: _this, dataSource: _this.dataSource }, _this.config.list, config)));
        };
        this.getCreateView = function (config, _a, onCancel) {
...
{
    if (this.editLayout) {
        return this.editLayout({ entity: this, onSave: onSave });
    }
    return (React.createElement(EntityEditLayout, __assign({ entity: this, onSave: onSave }, this.config.edit, config)));
}
;
getEditView = function (config, onSave) {
    if (_this.editLayout) {
        return _this.editLayout({ entity: _this, onSave: onSave });
    }
    return (React.createElement(EntityEditLayout, __assign({ entity: _this, onSave: onSave }, _this.config.edit, config)));
};
inputField(name, string, config ?  : IEntityFieldConfig(), Entity < T > {
    this: .fields.push(new EntityField(name, config || {}, this)),
    return: this
}, public, textField(name, string, config ?  : IEntityFieldConfig(), Entity < T > {
    this: .fields.push(new EntityFieldText(name, config || {}, this)),
    return: this
}, public, numberField(name, string, config ?  : IEntityFieldConfig(), Entity < T > {
    this: .fields.push(new EntityFieldNumber(name, config || {}, this)),
    return: this
}, public, passwordField(name, string, config ?  : IEntityFieldConfig(), Entity < T > {
    this: .fields.push(new EntityFieldPasssword(name, config || {}, this)),
    return: this
}, public, dateField(name, string, config ?  : IEntityFieldDateConfig(), Entity < T > {
    this: .fields.push(new EntityFieldDate(name, config || {}, this)),
    return: this
}, public, booleanField(name, string, config ?  : IEntityFieldBooleanConfig(), Entity < T > {
    this: .fields.push(new EntityFieldBoolean(name, config || {}, this)),
    return: this
}, public, relationshipField(name, string, config, IEntityFieldRelationshipConfig(), Entity < T > {
    this: .fields.push(new EntityFieldRelationship(name, config, this)),
    return: this
}, public, colorField(name, string, config ?  : IEntityFieldConfig(), Entity < T > {
    this: .fields.push(new EntityFieldColor(name, config || {}, this)),
    return: this
}, public, enumField(name, string, config, IEntityFieldEnumConfig(), Entity < T > {
    this: .fields.push(new EntityFieldEnum(name, config, this)),
    return: this
}, public, computedField(name, string, config ?  : IEntityFieldComputedConfig(), Entity < T > {
