...
var Entity = /** @class */ (function () {
    ...
    // resource hooks
    Entity.prototype.useResource = function (resourceID, config) {
        var entityFields = this.getDetailFields(resourceID);
        return useResource(__assign(__assign({ fields: __spreadArray([
                "id"
            ], entityFields
                .map(function (x) { return x && x.fetchField(); })
                .filter(function (x) { return x; })) }, config), { name: this.name, id: resourceID, dataSource: this.dataSource }));
    };
    Entity.prototype.useResourceCollection = function (config) {
        ...
        return useResourceCollection(__assign(__assign({ fields: __spreadArray([
                ...
                .map(function (x) { return x && x.fetchField(); })
                .filter(function (x) { return x; })) }, config), { name: this.name, dataSource: this.dataSource }));
    };
    return Entity;
}());
export { Entity };
