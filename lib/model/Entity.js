    ...
    function Entity(config) {
        ...
        this.getSearchResourceCollectionLayer = function (render, props) {
            return (React.createElement(ResourceCollectionLayer, __assign({ name: _this.name, fields: [
                    "id"
                ].concat(_this.searchableFields.map(function (x) { return x.fetchField() || x.name; })), initialSorting: _this.initialSorting, initialFilters: _this.initialFilters, dataSource: _this.dataSource }, props, { render: render })));
        };
    }
