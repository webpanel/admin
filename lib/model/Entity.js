    ...
    function Entity(config) {
        ...
        this.structureItem = function () {
            return (React.createElement(Layout.StructureItem, { key: "/" + _this.structureName, name: _this.title, header: {
                ...
                }, content: React.createElement(EntityList, { entity: _this, dataSource: _this.dataSource, detailButtonText: _this.config.showDetailPage ? 'Detail' : 'Edit' }) },
        ...
        this.getCreatePageLayout = function (route) {
            ...
            return (React.createElement(EntityEditLayout, { entity: _this, route: route, onCreate: function (id) {
