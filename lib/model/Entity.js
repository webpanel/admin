...
var Entity = /** @class */ (function () {
    function Entity(config) {
        ...
        this.menuItem = function () {
            return (React.createElement(Layout.MenuItem, { key: _this.structureName, title: React.createElement(Translation, null, function (t) {
        ...
        this.structureItem = function () {
            return (React.createElement(Layout.StructureItem, { key: "/" + _this.structureName, name: React.createElement(Translation, null, function (t) {
                ...
                //   </Link>
                // )
                }, content: function () { return _this.getListView(_this.getListConfig()); } },
        ...
        this.getDetailPageLayout = function (route, config) {
            ...
            if (_this.config.showDetailPage) {
                ...
                return (React.createElement(EntityDetailLayout, __assign({ entity: _this, resourceID: resourceID }, _this.getDetailConfig(resourceID), config)));
            }
        ...
        this.getEditPageLayout = function (route, config) {
            ...
            return (React.createElement(EntityEditLayout, __assign({ entity: _this, onSave: onSave, resourceID: resourceID }, _this.getEditConfig(resourceID), config)));
        };
        this.getCreatePageLayout = function (route, config) {
            ...
            return (React.createElement(EntityEditLayout, __assign({ entity: _this, onSave: onSave }, _this.getEditConfig(), config)));
        };
        // views
        ...
        this.getCreateView = function (config, handlers) {
            ...
            if (_this.createLayout) {
                return _this.createLayout(__assign({ entity: _this, onSave: onSave, onCancel: onCancel }, config));
            }
            return (React.createElement(EntityEditLayout, __assign({ entity: _this, onSave: onSave, onCancel: onCancel }, _this.getEditConfig(), config)));
        };
        ...
        this.getEditView = function (resourceID, config, handlers) {
            ...
            if (_this.editLayout) {
                return _this.editLayout(__assign({ entity: _this, onSave: onSave, onCancel: onCancel }, config), resourceID);
            }
            return (React.createElement(EntityEditLayout, __assign({ entity: _this, resourceID: resourceID, onSave: onSave, onCancel: onCancel }, _this.getEditConfig(resourceID), config)));
        };
