...
var Entity = /** @class */ (function () {
    function Entity(config) {
        ...
        this.menuItem = function () {
            return (React.createElement(Layout.MenuItem, { key: _this.structureName, title: _this.title, icon: resolveOptionalThunk(_this.config.icon) || 'folder' }));
        };
        this.structureItem = function () {
            return (React.createElement(Layout.StructureItem, { key: "/" + _this.structureName, name: _this.title, header: {
                ...
                //   </Link>
                // )
                }, content: React.createElement(EntityList, __assign({ entity: _this, dataSource: _this.dataSource }, _this.config.list)) },
    ...
    Object.defineProperty(Entity.prototype, "listFields", {
        get: function () {
            return this.fields.filter(function (f) { return f.visible('list') && f.hasPermission('read'); });
        },
        enumerable: true,
        configurable: true
    });
    ...
    Entity.prototype.editFieldsWithPermission = function (permission) {
        return this.editFields.filter(function (f) { return f.hasPermission(permission); });
    };
    Object.defineProperty(Entity.prototype, "detailFields", {
        get: function () {
            return this.fields.filter(function (f) { return f.visible('detail') && f.hasPermission('read'); });
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Entity.prototype, "searchableFields", {
        get: function () {
            var fields = this.fields.filter(function (f) { return f.visible('search', true) && f.hasPermission('read'); });
            if (fields.length === 0) {
