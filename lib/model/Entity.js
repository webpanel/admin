        ...
        get: function () {
            ...
            if (listConfig) {
                ...
                if (listFields) {
                    ...
                    return this.fields.filter(function (f) { return _listFields_1.indexOf(f.name) !== -1; });
                }
            }
            return this.fields;
        },
    ...
    Object.defineProperty(Entity.prototype, "editFields", {
        get: function () {
            ...
            if (editConfig) {
                ...
                if (listFields_1) {
                    return this.fields.filter(function (f) { return listFields_1.indexOf(f.name) !== -1; });
                }
            }
            return this.fields;
        },
    ...
    Object.defineProperty(Entity.prototype, "detailFields", {
        get: function () {
            ...
            if (detailConfig) {
                ...
                if (listFields_2) {
                    return this.fields.filter(function (f) { return listFields_2.indexOf(f.name) !== -1; });
                }
            }
            return this.fields;
        },
    ...
    Object.defineProperty(Entity.prototype, "searchableFields", {
        get: function () {
            ...
            if (search && typeof search !== 'boolean') {
                ...
                if (searchFields_1) {
                    fields = this.fields.filter(function (f) { return searchFields_1.indexOf(f.name) !== -1; });
                }
            }
