...
var Entity = /** @class */ (function () {
    function Entity(config) {
        ...
        this.structureItem = function () {
            return (React.createElement(Layout.StructureItem, { key: "/" + _this.structureName, name: _this.title, content: React.createElement(EntityList, { entity: _this, dataSource: _this.config.dataSource, detailButtonText: _this.config.showDetailPage
                        ? 'Detail'
                        : 'Edit' }) },
                React.createElement(Layout.StructureItem, { key: "/new", name: "New", content: function (route) { return (React.createElement(EntityEdit, { entity: _this, route: route, detailOnCreate: _this.config.showDetailPage })); } }),
                React.createElement(Layout.StructureItem, { key: "/:id", name: "Detail", content: function (route) { return (_this.config.showDetailPage
                        ? React.createElement(EntityDetail, { entity: _this, dataSource: _this.dataSource, route: route })
                        : React.createElement(Redirect, { push: true, to: route.match.params.id + "/edit" })); } }),
                React.createElement(Layout.StructureItem, { key: "/:id/edit", name: "Edit", content: function (route) { return (React.createElement(EntityEdit, { entity: _this, route: route })); } })));
        };
    }
