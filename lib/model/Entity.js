...
var Entity = /** @class */ (function () {
    function Entity(config) {
        ...
        this.menuItem = function () {
            return (componentPermission(_this.structureName) && (React.createElement(Translation, null, function (t) { return (React.createElement(Layout.MenuItem, { key: _this.structureName, title: t(_this.name, { defaultValue: _this.title }), icon: resolveOptionalThunk(_this.config.icon) || 'folder' })); })));
        };
        this.structureItem = function () {
            return (React.createElement(Translation, null, function (t) { return (React.createElement(Layout.StructureItem, { key: _this.getListLink(), name: t(_this.name, { defaultValue: _this.title }), header: {
                ...
                React.createElement(Layout.StructureItem, { key: "/new", name: t('common.new', { defaultValue: 'New' }), header: {
                    // title: 'New'
                    }, content: _this.getCreatePageLayout }),
                React.createElement(Layout.StructureItem, { key: "/:id", name: t('common.detail', { defaultValue: 'Detail' }), header: function (route) { return ({
                    // title: `Detail`,
                    // action: (
                ...
                React.createElement(Layout.StructureItem, { key: "/:id/edit", name: t('common.edit', { defaultValue: 'Edit' }), header: {
                    // title: 'Edit'
