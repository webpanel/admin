...
var Entity = /** @class */ (function () {
    function Entity(config) {
        ...
        this.getDetailPageLayout = function (route) {
            ...
            if (_this.config.showDetailPage) {
                if (_this.detailLayout) {
                    return _this.detailLayout({ entity: _this, resourceID: resourceID });
                }
                return React.createElement(EntityDetailLayout, { entity: _this, resourceID: resourceID });
            }
        ...
        this.getEditPageLayout = function (route, config) {
            ...
            var resourceID = route.match.params.id;
            if (_this.editLayout) {
                return _this.editLayout({ entity: _this, onSave: onSave }, resourceID);
            }
        ...
        this.getListView = function (config) {
            var listConfig = resolveOptionalThunk(_this.config.list);
            return (React.createElement(EntityList, __assign({ entity: _this, dataSource: _this.dataSource }, listConfig, config)));
        };
        this.getDetailView = function (resourceID, config) {
            return (React.createElement(EntityDetailLayout, __assign({ entity: _this, resourceID: resourceID }, config)));
        };
        this.getCreateView = function (config, handlers) {
            ...
            // }
            return (React.createElement(EntityEditLayout, __assign({ entity: _this, onSave: onSave, onCancel: onCancel }, _this.config.edit, config)));
        };
        this.getEditView = function (resourceID, config, handlers) {
            ...
            return (React.createElement(EntityEditLayout, __assign({ entity: _this, resourceID: resourceID, onSave: onSave, onCancel: onCancel }, _this.config.edit, config)));
        };
    }
