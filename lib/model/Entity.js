...
var Entity = /** @class */ (function () {
    function Entity(config) {
        ...
        this.structureItem = function () {
            return (React.createElement(Layout.StructureItem, { key: _this.getListLink(), name: React.createElement(Translation, null, function (t) {
        ...
        this.getResourceCollectionLayer = function (render, props) {
            return (React.createElement(ResourceCollectionLayer, __assign({ name: _this.name, fields: [
                    'id'
                ].concat(_this.searchableFields.map(function (x) { return x.name; })), initialSorting: _this.initialSorting, initialFilters: _this.initialFilters, dataSource: _this.dataSource }, props, { render: render })));
        };
    }
