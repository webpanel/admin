...
var EntityField = /** @class */ (function () {
    ...
    EntityField.prototype.fieldElement = function (key, config, values) {
        ...
        var formItem = function () { return (React.createElement(Form.Item, __assign({ name: _this.columnName(), valuePropName: _this.valuePropName, rules: resolveOptionalThunk(_this.config.rules), label: React.createElement(Translation, null, function (t) {
                return t(_this.entity.name + "." + _this.name, {
                    defaultValue: _this.title,
                });
            }), extra: resolveOptionalThunk(_this.config.description) }, formItemLayout), _this.inputElement({
            values: values,
