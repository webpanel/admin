...
var EntityField = /** @class */ (function () {
    ...
    EntityField.prototype.fieldElement = function (field, formContext, key) {
        return (React.createElement(FormField, { key: key, label: field.title, name: field.columnName, formContext: formContext, valuePropName: this.valuePropName }, this.inputElement()));
    };
    return EntityField;
}());
export { EntityField };
