...
var EntityField = /** @class */ (function () {
                    ...
                    case 'relationship':
                        ...
                        if (targetEntity) {
                            ...
                            return function (values) {
                                ...
                                return render_1 && render_1(values);
                            };
                        }
                }
            }
    ...
    EntityField.prototype.fieldElement = function (formContext, key) {
        ...
        return (React.createElement(FormField, { key: key, label: this.title, name: this.name, formContext: formContext, valuePropName: valuePropName }, this.inputElement()));
    };
