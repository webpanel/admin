...
var EntityField = /** @class */ (function () {
        ...
        this.filterDropdown = function (resource) {
            return function (props) {
                return (React.createElement("div", { style: {
                    ...
                    React.createElement(Button, { style: { marginRight: 2 }, disabled: !props.selectedKeys, onClick: function () { return props.confirm(); }, type: "primary", icon: "search" }),
    ...
    EntityField.prototype.fieldElement = function (formContext, key, config) {
        ...
        var formItemLayout = config.formLayout === "horizontal"
            ...
            : null;
        return (React.createElement(Translation, null, function (t) { return (React.createElement(FormField, __assign({ key: key, label: t(_this.entity.name + "." + _this.name, {
                defaultValue: _this.title,
            }), extra: resolveOptionalThunk(_this.config.description), name: _this.columnName(), formContext: formContext, valuePropName: _this.valuePropName, rules: resolveOptionalThunk(_this.config.rules) }, formItemLayout), _this.inputElement({ formContext: formContext }))); }));
    };
    return EntityField;
}());
export { EntityField };
