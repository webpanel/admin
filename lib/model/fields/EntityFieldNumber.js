...
var EntityFieldNumber = /** @class */ (function (_super) {
    ...
    function EntityFieldNumber(name, config, _entity) {
        ...
        _this.filterDropdownInput = function (props) {
            ...
            return (React.createElement(InputNumber, { style: { minWidth: "195px" }, key: "number_field_" + _this._entity.name + "_" + _this.valuePropName, placeholder: "Number", value: value, onChange: function (value) {
    ...
    EntityFieldNumber.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(InputNumber, __assign({ style: { minWidth: "195px", width: "100%" }, key: "number_field_" + this._entity.name + "_" + this.valuePropName, formatter: function (value) { return formatter(value, _this.config.format); }, parser: function (value) {
                return parser(value || "");
