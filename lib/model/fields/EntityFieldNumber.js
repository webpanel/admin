...
var EntityFieldNumber = /** @class */ (function (_super) {
    ...
    function EntityFieldNumber() {
        ...
        _this.filterDropdownInput = function (props) {
            ...
            return (React.createElement(InputNumber, { key: "number_field_" + _this.entity.name + "_" + _this.valuePropName, placeholder: "Number", value: value, onChange: function (value) {
    ...
    EntityFieldNumber.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(InputNumber, __assign({ key: "number_field_" + this.entity.name + "_" + this.valuePropName }, props, { onChange: onChangeProp })));
    };
    Object.defineProperty(EntityFieldNumber.prototype, "filterFormatter", {
        get: function () {
            var _this = this;
