...
var EntityFieldNumber = /** @class */ (function (_super) {
    ...
    EntityFieldNumber.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(InputNumber, __assign({ style: { minWidth: "195px" }, key: "number_field_" + this.entity.name + "_" + this.valuePropName, formatter: function (value) { return formatter(value); }, parser: function (value) { return parser(value || ""); } }, props, { onChange: onChangeProp })));
    };
