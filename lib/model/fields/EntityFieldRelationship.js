...
var EntityFieldRelationship = /** @class */ (function (_super) {
    ...
    EntityFieldRelationship.prototype.fieldElement = function (formContext, key, config) {
        ...
        var formItemLayout = config.formLayout === 'horizontal'
            ...
            : null;
        return _targetEntity.getResourceCollectionLayer(function (collection) { return (React.createElement(Translation, { key: key }, function (t) { return (React.createElement(FormField, __assign({ label: t(_this.entity.name + "." + _this.name, {
    ...
    EntityFieldRelationship.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return _targetEntity.getResourceCollectionLayer(function (collection) {
...
export var getRelationshipFilterDropdownInput = function (targetEntity, props) {
    ...
    return _targetEntity.getResourceCollectionLayer(function (resource) {
