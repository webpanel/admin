    ...
    function EntityFieldRelationship() {
        ...
        _this.filterDropdownInput = function (props) {
            ...
            return (React.createElement(ResourceCollectionLayer, { name: targetEntity.name, fields: [
                    ...
                    .filter(function (x) { return x; })), dataSource: _targetEntity.dataSource, initialFilters: _targetEntity.initialFilters, initialSorting: _targetEntity.initialSorting, autoload: false, render: function (resource) {
