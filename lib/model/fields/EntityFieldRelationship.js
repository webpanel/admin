            ...
            return function (values) {
                ...
                if (type === "toMany" && Array.isArray(value)) {
                    return value
                        ...
                        if (_showLink) {
                            return React.createElement("a", { href: _targetEntity.getDetailLink(x.id) }, content);
                        }
                        return content;
                    })
                ...
                if (_showLink) {
                    content = React.createElement("a", { href: _targetEntity.getDetailLink(value.id) }, content);
                }
                return content;
            };
        },
