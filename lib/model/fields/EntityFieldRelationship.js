...
var EntityFieldRelationship = /** @class */ (function (_super) {
    ...
    function EntityFieldRelationship() {
        ...
        _this.filterDropdownInput = function (props) {
            ...
            return (React.createElement(ResourceCollectionLayer, { name: targetEntity.name, fields: [
                    'id'
                ].concat(_targetEntity.searchableFields.map(function (x) { return x.fetchField; })), dataSource: _targetEntity.dataSource, initialFilters: _targetEntity.initialFilters, initialSorting: _targetEntity.initialSorting, render: function (resource) {
    ...
    Object.defineProperty(EntityFieldRelationship.prototype, "filterFormatter", {
        get: function () {
            var _this = this;
            return function (values) {
                var res = {};
