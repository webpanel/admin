...
var RelationshipSelectWithAddButton = function (props) {
    ...
    return (React.createElement(React.Fragment, null, targetEntity.getSearchResourceCollectionLayer(function (collection) { return (React.createElement(Row, null,
        React.createElement(Col, { flex: "auto" },
            ...
            , { 
                ...
                }, mode: field.mode, resourceCollection: collection, showSearch: true, style: {
                    width: "100%",
                    minWidth: "200px",
                }, onChange: function (value) { return onChange && onChange(value); } })),
        isCreatable && (React.createElement(Col, { flex: "32px" }, targetEntity.getCreateButton({
            ...
            onSave: function (id) { return __awaiter(void 0, void 0, void 0, function () {
...
var EntityFieldRelationship = /** @class */ (function (_super) {
    ...
    EntityFieldRelationship.prototype.fieldElement = function (key, config) {
        ...
        return (React.createElement(Translation, { key: key }, function (t) { return (React.createElement(FormItem, __assign({ label: t(_this.entity.name + "." + _this.name, {
    ...
    EntityFieldRelationship.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return _targetEntity.getSearchResourceCollectionLayer(function (collection) {
        ...
        get: function () {
            ...
            return function (values) {
                ...
                var value = values[_this.columnName()] ||
                    values[_this.columnName() + "Id"] ||
                    values[_this.columnName() + "Id_in"] ||
                    values[_this.columnName().replace("Ids", "").replace("Id", "")];
                if (value) {
                    if (value.id) {
                        res = [value.id];
                    }
...
export var getRelationshipFilterDropdownInput = function (targetEntity, props) {
    ...
    return _targetEntity.getSearchResourceCollectionLayer(function (resource) {
        return (React.createElement(ResourceSelect, { valueKey: "id", labelKey: function (value) {
                return _targetEntity.render(value);
            }, value: value, mode: "multiple", allowClear: false, showSearch: true, resourceCollection: resource, style: { minWidth: "200px" }, onChange: function (value) {
