...
var EntityFieldRelationship = /** @class */ (function (_super) {
    ...
    function EntityFieldRelationship() {
        ...
        _this.filterDropdownInput = function (props) {
            ...
            return (React.createElement(ResourceCollectionLayer, { name: targetEntity.name, fields: [
                    ...
                    .filter(function (x) { return x; })), dataSource: _targetEntity.dataSource, initialFilters: _targetEntity.initialFilters, initialSorting: _targetEntity.initialSorting, render: function (resource) {
                    ...
                    return (React.createElement(ResourceSelect, { valueKey: "id", labelKey: function (value) {
                        ...
                        }, value: value, mode: _this.mode, allowClear: false, resourceCollection: resource, style: { minWidth: '200px' }, onChange: function (value, option) {
            ...
            return function (values) {
                ...
                if (type === 'toMany' && Array.isArray(value)) {
                    return value
                        ...
                        .map(function (x) { return React.createElement(Tag, { key: x }, x); });
                }
    ...
    EntityFieldRelationship.prototype.fieldElement = function (formContext, key, config) {
        ...
        return (React.createElement(ResourceCollectionLayer, { key: key, name: _targetEntity.name, fields: [
                'id'
            ].concat(_targetEntity.searchableFields.map(function (x) { return x.name; })), initialSorting: _targetEntity.initialSorting, initialFilters: _targetEntity.initialFilters, dataSource: _targetEntity.dataSource, render: function (collection) { return (React.createElement(FormField, __assign({ label: _this.title, name: _this.columnName, formContext: formContext, style: {
                    width: '100%'
                } }, formItemLayout),
                React.createElement(ResourceSelect, { valueKey: "id", labelKey: function (value) {
                        return _targetEntity.render(value);
                    }, mode: _this.mode, resourceCollection: collection, style: {
                        width: '100%',
                        minWidth: '200px',
                        marginRight: '-38px',
                        paddingRight: '38px'
                    } }),
                entityPermission(_targetEntity, 'create') && (React.createElement(Button, { size: "small", icon: "plus", style: {
    ...
    EntityFieldRelationship.prototype.inputElement = function (props) {
        ...
        return (React.createElement(ResourceCollectionLayer, { name: _targetEntity.name, fields: [
                ...
                return (React.createElement(ResourceSelect, __assign({}, props, { valueKey: "id", allowClear: true, style: { width: '100%', minWidth: '200px' }, labelKey: function (value) {
                        return _targetEntity.render(value);
