...
var EntityFieldRelationship = /** @class */ (function (_super) {
    ...
    EntityFieldRelationship.prototype.fieldElement = function (formContext, key, config) {
        ...
        var isCreatable = (_targetEntity.creatable && _isCreatable) ||
            typeof _isCreatable === "undefined";
        return _targetEntity.getSearchResourceCollectionLayer(function (collection) { return (React.createElement(Translation, { key: key }, function (t) { return (React.createElement(FormField, __assign({ label: t(_this.entity.name + "." + _this.name, {
            ...
            isCreatable &&
                _targetEntity.getCreateButton({
                    key: "relationship_field_" + _this.entity.name + "_" + _this.valuePropName + "_add",
                    button: {
                        style: {
                            margin: config.formLayout === "horizontal"
                                ? "4px 0 0 4px"
                                : "0 0 0 4px",
                        },
                    },
                    ...
                    onCreate: function (id) { return __awaiter(_this, void 0, void 0, function () {
                        var updateValues;
        ...
        var onChangeProp = onChange
            ? function (value, option) {
                ...
                onChange(value || null, options
                    .map(function (o) { return o && o.props.children; })
                    .filter(function (x) { return x; })
                    .join(", "));
            }
            : undefined;
...
export var getRelationshipFilterDropdownInput = function (targetEntity, props) {
    ...
    return _targetEntity.getSearchResourceCollectionLayer(function (resource) {
        return (React.createElement(ResourceSelect, { valueKey: "id", labelKey: function (value) {
                return _targetEntity.render(value);
            }, value: value, mode: "multiple", allowClear: false, showSearch: true, resourceCollection: resource, style: { minWidth: "200px" }, onChange: function (value, option) {
