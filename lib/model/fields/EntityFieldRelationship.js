...
var EntityFieldRelationship = /** @class */ (function (_super) {
    ...
    EntityFieldRelationship.prototype.fieldElement = function (formContext, key, config) {
        ...
        return (React.createElement(ResourceCollectionLayer, { key: key, name: _targetEntity.name, fields: [
                ...
                entityPermission(_targetEntity, 'create') && (React.createElement(CreateEntityButton, { key: "relationship_field_" + _this.entity.name + "_" + _this.valuePropName + "_add", entity: _targetEntity, formLayout: config.formLayout, modalTitle: "Add " + _targetEntity.title, onCreate: function (id) { return __awaiter(_this, void 0, void 0, function () {
                        var updateValues;
...
var CreateEntityButton = /** @class */ (function (_super) {
    ...
    CreateEntityButton.prototype.render = function () {
        var _this = this;
        var _a = this.props, entity = _a.entity, modalTitle = _a.modalTitle, onCreate = _a.onCreate, formLayout = _a.formLayout, options = __rest(_a, ["entity", "modalTitle", "onCreate", "formLayout"]);
        var addButtonMargin = formLayout === 'horizontal' ? '4px 0 0 4px' : '0 0 0 4px';
        return (React.createElement(React.Fragment, null,
            React.createElement(Button, { tabIndex: -1, size: "small", icon: "plus", style: {
                    margin: addButtonMargin,
                    height: '32px'
                }, onClick: function () { return _this.setState({ showModal: true }); } }),
            entity.getCreateView(__assign({ wrapperType: 'modal', modal: {
                    title: modalTitle,
