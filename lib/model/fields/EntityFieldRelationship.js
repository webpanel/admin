...
var EntityFieldRelationship = /** @class */ (function (_super) {
    ...
    function EntityFieldRelationship() {
        ...
        _this.updateFilterField = function (resource, operationName, value, customName) {
            ...
            if (value) {
                filters[_this.name] = (_a = {}, _a[filterName] = value, _a);
            }
            else {
                delete filters[_this.name];
            }
            resource.updateNamedFilters(_this.name, filters, true);
        };
        _this.clearFilters = function (resource) {
            var filters = (resource.filters || {})[_this.name] || {};
            delete filters[_this.name];
            resource.updateNamedFilters(_this.name, filters, true);
        };
        _this.filterDropdownInput = function (mainResource) {
            ...
            return (React.createElement(ResourceCollectionLayer, { name: targetEntity.name, fields: [
                    ...
                    return React.createElement(React.Fragment, null,
                        React.createElement(Select, { style: { minWidth: '128px' }, onChange: function (value) {
                                return _this.updateFilterField(mainResource, 'in', value, 'id');
                            } }, (resource.data || []).map(function (value) {
                            return React.createElement(Select.Option, { value: value.id }, value.name);
                        })),
                        React.createElement(Button, { onClick: function () {
                                return _this.clearFilters(mainResource);
                            } }, "Reset"));
                } }));
        };
        return _this;
