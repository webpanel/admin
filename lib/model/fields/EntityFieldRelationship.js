...
var EntityFieldRelationship = /** @class */ (function (_super) {
    ...
    EntityFieldRelationship.prototype.inputElement = function (props) {
        ...
        return (React.createElement(ResourceSelect, __assign({}, props, { valueKey: "id", style: { width: "100%", minWidth: "200px" }, labelKey: function (value) {
                return _targetEntity.render(value);
            }, mode: this.mode, resource: resourceConfig, 
            // labelInValue={true}
...
export var getRelationshipFilterDropdownInput = function (targetEntity, props) {
    ...
    return (React.createElement(ResourceSelect, { valueKey: "id", labelKey: function (value) {
            return _targetEntity.render(value);
        }, value: value, mode: "multiple", allowClear: false, showSearch: true, resource: resourceConfig, style: { minWidth: "200px" }, onChange: function (value) {
