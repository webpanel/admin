...
var RelationshipSelectWithAddButton = function (props) {
    ...
    var getAddButton = function () {
        return (React.createElement(Col, { flex: "32px" }, targetEntity.getCreateButton({
            key: "relationship_field_".concat(field._entity.name, "_").concat(field.valuePropName, "_add"),
            flow: {
                type: "modal",
                modal: {
                    title: _t("".concat(targetEntity.name, "._title"), {
...
var EntityFieldRelationship = /** @class */ (function (_super) {
    ...
    EntityFieldRelationship.prototype.columnName = function () {
        return "".concat(this.name).concat(this.type === "toOne" ? "Id" : "Ids");
    };
    ...
    EntityFieldRelationship.prototype.fetchField = function () {
        ...
        name += "{ id ".concat(searchFields
            .map(function (x) { return x.fetchField(); })
            .join(" "), "} ").concat(this.columnName(), " ");
        return name;
    };
            ...
            return function (values, options) {
                ...
                if (type === "toMany" && Array.isArray(value)) {
                    var arr = value.map(function (x) {
                        ...
                        var content = _render && _render(x, options);
                        if (options === null || options === void 0 ? void 0 : options.forceString) {
                            return content;
                        }
                        if (_showLink) {
                            content = (React.createElement(Link, { to: _targetEntity.getDetailLink(x.id) }, content));
                        }
                        return React.createElement(Tag, { key: String(x) }, content);
                    });
                    if (options === null || options === void 0 ? void 0 : options.forceString) {
                        return arr.join(", ");
                    }
                ...
                var content = _render && _render(value, options);
                if (options === null || options === void 0 ? void 0 : options.forceString) {
                    return content;
                }
                if (_showLink) {
