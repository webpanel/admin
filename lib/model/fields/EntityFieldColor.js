...
export var ColorInput = function (_a) {
    ...
    return (React.createElement(Space, null,
        React.createElement("input", { key: "" + version, value: value || undefined, type: "color", onChange: function (event) {
...
var EntityFieldColor = /** @class */ (function (_super) {
    ...
    EntityFieldColor.prototype.inputElement = function (props) {
        ...
        return (React.createElement(ColorInput, { key: "color_field_" + this._entity.name + "_" + this.valuePropName, value: value, onChange: function (value) {
