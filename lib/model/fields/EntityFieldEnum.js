...
var EntityFieldEnum = /** @class */ (function (_super) {
    ...
    EntityFieldEnum.prototype.inputElement = function (props) {
        var _this = this;
        var selectOptions = resolveThunk(this.config.options).map(function (value) { return (React.createElement(Select.Option, { key: "enum_field_" + _this._entity.name + "_" + _this.valuePropName + "_" + value.value, value: value.value }, value.label)); });
        return (React.createElement(Select, __assign({ style: {
                width: "100%",
                minWidth: "100px",
            }, key: "enum_field_" + this._entity.name + "_" + this.valuePropName, showSearch: true, allowClear: true }, props), selectOptions));
    };
