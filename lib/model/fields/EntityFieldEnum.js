...
var EntityFieldEnum = /** @class */ (function (_super) {
    ...
    function EntityFieldEnum() {
        ...
        _this.filterDropdownInput = function (resource) {
            ...
            return (React.createElement(Select, { onChange: function (value) { return _this.updateFilterField(resource, 'in', value); } }, selectOptions));
        };
        return _this;
    }
    ...
    EntityFieldEnum.prototype.inputElement = function (props) {
        var selectOptions = resolveThunk(this.config.options).map(function (value) { return (React.createElement(Select.Option, { value: value.value }, value.label)); });
        return React.createElement(Select, __assign({}, props), selectOptions);
    };
    EntityFieldEnum.prototype.isFiltered = function (resource) {
