...
var EntityFieldEnum = /** @class */ (function (_super) {
    ...
    function EntityFieldEnum() {
        ...
        _this.filterDropdownInput = function (props) {
            ...
            return (React.createElement(Select, { value: value, onChange: function (value) { return props.setSelectedKeys([value]); }, showSearch: true }, selectOptions));
        };
        return _this;
    }
    ...
    EntityFieldEnum.prototype.inputElement = function (props) {
        ...
        return (React.createElement(Select, __assign({ style: {
                width: '100%'
            }, key: "enum_field_" + this.entity.name + "_" + this.valuePropName, showSearch: true }, props), selectOptions));
    };
