...
var EntityFieldEnum = /** @class */ (function (_super) {
    ...
    EntityFieldEnum.prototype.inputElement = function (props) {
        var _this = this;
        var selectOptions = resolveThunk(this.config.options).map(function (value) { return (React.createElement(Select.Option, { key: "enum_field_" + _this.entity.name + "_" + _this.valuePropName, value: value.value }, value.label)); });
