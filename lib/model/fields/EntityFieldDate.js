...
var EntityFieldDate = /** @class */ (function (_super) {
    ...
    EntityFieldDate.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(DatePicker, __assign({ key: "enum_field_" + this.entity.name + "_" + this.valuePropName, showTime: this.config.showTime, format: this.format }, props, { onChange: onChangeProp })));
    };
