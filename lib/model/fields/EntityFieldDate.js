...
export var dateFieldFilter = function (columnName, range, format, showTime) {
    return {
        dropdownInput: function (props) {
            ...
            return range ? (React.createElement(AntdDatePicker.RangePicker, { format: format || showTime ? "YYYY/MM/DD HH:mm" : "YYYY/MM/DD", allowClear: false, value: [value[0] && moment(value[0]), value[1] && moment(value[1])], onChange: function (dates) {
                    if (dates != null) {
...
var EntityFieldDate = /** @class */ (function (_super) {
    ...
    EntityFieldDate.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(DatePicker, __assign({ key: "date_field_" + this._entity.name + "_" + this.valuePropName, showTime: this.config.showTime, format: this.format }, props, { onChange: onChangeProp })));
    };
