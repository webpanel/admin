...
export var PercentageInput = function (props) {
    ...
    return (React.createElement(InputNumber, __assign({ value: value && value * 100, onChange: function (v) {
        ...
        }, formatter: function (value) { return "".concat(value, "%"); }, parser: function (value) { return (value && value.replace("%", "")) || ""; } }, rest)));
};
var EntityFieldPercentage = /** @class */ (function (_super) {
    ...
    function EntityFieldPercentage(name, config, _entity) {
        ...
        _this.filterDropdownInput = function (props) {
            ...
            return (React.createElement(PercentageInput, { style: { minWidth: "195px" }, key: "number_field_".concat(_this._entity.name, "_").concat(_this.valuePropName), placeholder: "Number", value: value, onChange: function (value) {
    ...
    EntityFieldPercentage.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(PercentageInput, __assign({ style: { minWidth: "195px", width: "100%" }, key: "number_field_".concat(this._entity.name, "_").concat(this.valuePropName) }, props, { onChange: onChangeProp })));
    };
