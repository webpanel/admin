...
var EntityFieldPercentage = /** @class */ (function (_super) {
    ...
    function EntityFieldPercentage(name, config, entity) {
        ...
        _this.filterDropdownInput = function (props) {
            ...
            return (React.createElement(PercentageInput, { style: { minWidth: "195px" }, key: "number_field_" + _this.entity.name + "_" + _this.valuePropName, placeholder: "Number", value: value, onChange: function (value) {
    ...
    EntityFieldPercentage.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(PercentageInput, __assign({ style: { minWidth: "195px", width: "100%" }, key: "number_field_" + this.entity.name + "_" + this.valuePropName }, props, { onChange: onChangeProp })));
    };
