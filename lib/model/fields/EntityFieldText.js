...
var EntityFieldText = /** @class */ (function (_super) {
    ...
    EntityFieldText.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(Input.TextArea, { key: "text_field_" + this._entity.name + "_" + this.valuePropName, autoFocus: props === null || props === void 0 ? void 0 : props.autoFocus, autoSize: { minRows: 2, maxRows: 8 }, onChange: onChangeProp }));
    };
