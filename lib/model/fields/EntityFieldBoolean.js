...
var IndeterminateCheckbox = function (props) {
    ...
    return (React.createElement(Checkbox, __assign({}, rest, { indeterminate: checked === null, checked: checked })));
};
var EntityFieldBoolean = /** @class */ (function (_super) {
    ...
    EntityFieldBoolean.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(IndeterminateCheckbox, __assign({ key: "boolean_field_" + this.entity.name + "_" + this.valuePropName, indeterminate: (props === null || props === void 0 ? void 0 : props.value) === null }, props, { onChange: onChangeProp })));
    };
