...
var EntityFieldBoolean = /** @class */ (function (_super) {
    ...
    EntityFieldBoolean.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(IndeterminateCheckbox, __assign({ key: "boolean_field_".concat(this._entity.name, "_").concat(this.valuePropName) }, props, { onChange: onChangeProp })));
    };
