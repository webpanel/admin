...
var IndeterminateCheckbox = function (props) {
    ...
    return (React.createElement(Checkbox, __assign({}, rest, { indeterminate: value === null || typeof value === "undefined", checked: value, onChange: function (event) {
            if (onChange) {
...
var EntityFieldBoolean = /** @class */ (function (_super) {
    ...
    EntityFieldBoolean.prototype.inputElement = function (props) {
        var _this = this;
        var _a = props || {}, onChange = _a.onChange, rest = __rest(_a, ["onChange"]);
        var onChangeProp = onChange
            ? function (value) { return onChange(value, _this.renderValue(value)); }
            : undefined;
        return (React.createElement(IndeterminateCheckbox, __assign({ key: "boolean_field_".concat(this._entity.name, "_").concat(this.valuePropName), onChange: onChangeProp }, rest)));
    };
