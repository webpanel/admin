...
var EntityFieldFile = /** @class */ (function (_super) {
    ...
    EntityFieldFile.prototype.fetchField = function () {
        return "".concat(this.name, " { id name size }");
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, fetch("".concat(hostURL, "/").concat(id), {
                                method: "GET",
    ...
    EntityFieldFile.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(FileInput, __assign({ entity: this._entity, hostURL: this.config.hostURL, uploadURL: this.config.uploadURL, key: "text_field_".concat(this._entity.name, "_").concat(this.valuePropName), accessToken: accessToken }, props, { onChange: onChangeProp })));
    };
