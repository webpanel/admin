...
var EntityFieldFile = /** @class */ (function (_super) {
    ...
    EntityFieldFile.prototype.inputElement = function (props) {
        ...
        var onChangeProp = onChange
            ...
            : undefined;
        return (React.createElement(FileInput, __assign({ entity: this._entity, hostURL: this.config.hostURL, uploadURL: this.config.uploadURL, key: "text_field_" + this._entity.name + "_" + this.valuePropName, accessToken: accessToken }, props, { onChange: onChangeProp })));
    };
