...
var EntityWithFields = /** @class */ (function (_super) {
    ...
    function EntityWithFields() {
        ...
        _this.getSearchResourceCollectionConfig = function () {
            return {
                ...
                fields: __spreadArray([
                    "id"
                ], _this.searchableFields.map(function (x) { return x.fetchField() || x.name; }), true),
        ...
        _this.menuItem = function () {
            ...
            return (React.createElement(Layout.MenuItem, __assign({ key: _this.structureName, title: React.createElement(Translation, null, function (t) {
                    return t("".concat(_this.name, "._title"), {
                        count: 100,
        ...
        _this.structureItem = function () {
            ...
            return (React.createElement(Layout.StructureItem, __assign({ key: "/".concat(_this.structureName), name: React.createElement(Translation, null, function (t) {
                    return t("".concat(_this.name, "._title"), { count: 100, defaultValue: _this.title });
                }), 
                // header={
                //   {
        ...
        _this.getDetailPageLayout = function (route, config) {
            ...
            return React.createElement(Redirect, { to: "".concat(resourceID, "/edit") });
        };
    ...
    EntityWithFields.prototype.getFieldOrFail = function (name) {
        ...
        if (filtered.length === 0) {
            throw new Error("Cannot find field ".concat(name, " on entity ").concat(this.name));
        }
        return filtered[0];
    };
    ...
    EntityWithFields.prototype.useResource = function (config) {
        ...
        return useResource(__assign(__assign({ fields: __spreadArray([
                ...
                .filter(function (x) { return x; }), true) }, config), { name: this.resourceName, id: config === null || config === void 0 ? void 0 : config.id, dataSource: this.dataSource }));
    };
    EntityWithFields.prototype.useResourceCollection = function (config) {
        ...
        return useResourceCollection(__assign(__assign({ fields: __spreadArray([
                ...
                .map(function (x) { return x && x.fetchField(); })
                .filter(function (x) { return x; }), true) }, config), { name: this.resourceName, dataSource: this.dataSource }));
    };
