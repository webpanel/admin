...
var Admin = /** @class */ (function (_super) {
    ...
    Admin.prototype.render = function () {
        ...
        var _auth = auth;
        return _auth.type === "dummy" ? (React.createElement(DummyAuth, __assign({}, _auth, { children: content, form: form }))) : (React.createElement(Auth, __assign({}, _auth, { children: content, form: form, processing: function () { return React.createElement(Spin, { style: { width: "100%", marginTop: 80 } }); }, failed: function (_a) {
                var error = _a.error, logout = _a.logout;
                return (React.createElement(Result, { status: "403", title: error.message, subTitle: "" + error.description, extra: React.createElement(Button, { type: "primary", onClick: logout }, "Logout") }));
            } })));
    };
    Admin.Entity = Entity;
    return Admin;
