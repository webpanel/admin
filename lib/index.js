...
var Admin = /** @class */ (function (_super) {
    ...
    Admin.prototype.render = function () {
        var _a = this.props, auth = _a.auth, entities = _a.entities, menuItems = _a.menuItems, structureItems = _a.structureItems, autopermissions = _a.autopermissions, restProps = __rest(_a, ["auth", "entities", "menuItems", "structureItems", "autopermissions"]);
        configurePermissions(autopermissions);
        if (!auth) {
            return React.createElement(AdminLayout, { entities: entities, logout: function () { } });
        }
        var content = function (props) { return (React.createElement(AdminLayout, __assign({ entities: entities, menuItems: menuItems, structureItems: structureItems, header: {
                items: [
                    React.createElement(Translation, null, function (t, options) { return (React.createElement(Dropdown, { overlay: React.createElement(Menu, { onClick: function (value) {
        ...
        return auth.type === 'dummy' ? (React.createElement(DummyAuth, __assign({}, auth, { content: content, form: form }))) : (React.createElement(Auth, __assign({}, auth, { content: content, form: form })));
    };
    Admin.Entity = Entity;
    return Admin;
}(React.Component));
