...
var Admin = /** @class */ (function (_super) {
    ...
    Admin.prototype.render = function () {
        ...
        var _auth = auth;
        return _auth.type === "dummy" ? (React.createElement(DummyAuth, __assign({}, _auth, { children: content, form: form }))) : (React.createElement(Auth, __assign({}, _auth, { children: content, form: form, processing: function () { return React.createElement(Spin, null); }, failed: function (_a) {
