...
var Admin = /** @class */ (function (_super) {
    ...
    Admin.prototype.render = function () {
        ...
        return (React.createElement(AuthComp, __assign({}, auth, { content: function (props) { return (React.createElement(AdminLayout, __assign({ entities: entities }, props))); }, form: function (props) { return React.createElement(LoginForm, { authorizationInfo: props }); } })));
    };
    Admin.Entity = Entity;
    return Admin;
}(React.Component));
